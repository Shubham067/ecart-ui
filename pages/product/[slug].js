...
const Product = ({ product, categories, error, loading, slug }) => {
  ...
  }, [slug, dispatch, successProductReview]);
  ...
  const submitHandler = async (e) => {
    ...
    // We need to pull data from server to update the product reviews
    // after a new review gets added. So here we're performing a client-side
    // transition to the same route, which causes it to re-fetch the data as JSON
    // and pass it to the current page as props.
